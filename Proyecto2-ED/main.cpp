...
//    QString pathCieloB="/Users/sebastianbermudez/Documents/CodesS2/GitHub/Proyecto2-ED/Proyecto2-ED/infoB/Cielo/";
//    QDateTime actual = QDateTime::currentDateTime();
//    cielo->archivoCielo=pathCieloB+"Salvados_"+actual.date().toString("yyyyMMdd")+"_"+actual.time().toString("hhmmss")+".txt";
