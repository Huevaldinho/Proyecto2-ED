...
void Archivos::lecturaApellidos(QString * apellidos){
    ...
    rfile.open("D:\\OneDrive - Estudiantes ITCR\\Documentos\\GitHub\\ED\\Proyecto2-ED\\Proyecto2-ED\\archivosTexto//apellidos.txt");
...
void Archivos::lecturaNombres(QString * nombres){
    std::string line;
    std::ifstream rfile;//
    rfile.open("D:\\OneDrive - Estudiantes ITCR\\Documentos\\GitHub\\ED\\Proyecto2-ED\\Proyecto2-ED\\archivosTexto//nombres.txt");
    if (rfile.is_open()) {
