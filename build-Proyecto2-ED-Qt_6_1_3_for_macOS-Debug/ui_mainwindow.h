...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->setStyleSheet(QString::fromUtf8("background-color:  rgb(13, 47, 33)"));
        ...
        txt_PecadosFamiliaHumanoBuscado->setGeometry(QRect(10, 260, 261, 201));
        lbl_PecadosFamilia = new QLabel(centralwidget);
        lbl_PecadosFamilia->setObjectName(QString::fromUtf8("lbl_PecadosFamilia"));
        lbl_PecadosFamilia->setGeometry(QRect(80, 230, 131, 16));
        ...
        lbl_BuenasAcciones->setGeometry(QRect(350, 230, 181, 16));
        ...
        txt_BuenasAccionesFamiliaHumanoBuscado->setGeometry(QRect(300, 260, 271, 201));
        ...
        btn_Top10PaisesMasPecadores->setGeometry(QRect(50, 24, 191, 21));
        ...
        btn_Top5PaisesMenosPecadores->setGeometry(QRect(280, 24, 191, 21));
        ...
        btn_Top10PaisesConMasBuenasAcciones->setGeometry(QRect(20, 55, 251, 20));
        ...
        btn_Top5PaisesMenosBuenos->setGeometry(QRect(280, 54, 191, 21));
        ...
        lbl_textCantidadNivelesArbol->setGeometry(QRect(630, 20, 191, 16));
        ...
        lbl_CantidaNivelesArbol->setGeometry(QRect(710, 40, 55, 16));
        ...
        lbl_txtCantidadDeNodos->setGeometry(QRect(880, 20, 131, 16));
        ...
        lbl_CantidadDeNodos->setGeometry(QRect(930, 40, 55, 16));
        ...
        lbl_txtCantidadTotalHumanos->setGeometry(QRect(760, 70, 161, 16));
        ...
        lbl_CantidadTotalHumanos->setGeometry(QRect(830, 90, 55, 16));
        ...
        btnCondenacionLucifer->setGeometry(QRect(1110, 50, 80, 25));
        ...
        btnCondenacionAbadon->setGeometry(QRect(1210, 90, 80, 25));
        ...
        btnCondenacionMammon->setGeometry(QRect(1110, 130, 80, 25));
        ...
        btnCondenacionBelfegor->setGeometry(QRect(1210, 130, 80, 25));
        ...
        btnCondenacionAsmodeo->setGeometry(QRect(1160, 170, 80, 25));
        lblCondenar_2 = new QLabel(centralwidget);
        lblCondenar_2->setObjectName(QString::fromUtf8("lblCondenar_2"));
        lblCondenar_2->setGeometry(QRect(1330, 10, 61, 31));
        ...
        btnConsultaPor->setGeometry(QRect(260, 480, 80, 25));
        ...
        comboBoxBuscarFamiliaApellido->setGeometry(QRect(420, 590, 151, 24));
        ...
        comboBoxBuscarFamiliaPais->setGeometry(QRect(420, 630, 151, 24));
